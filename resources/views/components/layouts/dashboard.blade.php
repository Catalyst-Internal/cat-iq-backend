        ...
        <div class="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3">
            <div class="flex flex-wrap items-baseline gap-3">
                ...
                <nav class="flex gap-3 text-sm">
                    <a href="{{ route('admin.site-users.index') }}" @class([
                        'font-medium text-zinc-900 dark:text-zinc-100' => request()->routeIs('admin.site-users.index'),
                        'text-zinc-500 hover:text-zinc-800 dark:text-zinc-400 dark:hover:text-zinc-200' => ! request()->routeIs('admin.site-users.index'),
                    ])>Site users</a>
                </nav>
            </div>
